...
import read_MapillaryData as mapillary_parsing
import datetime
...
def main(argv=None):
    ...
    train_records, valid_records = mapillary_parsing.read_dataset(FLAGS.data_dir)
    print(len(train_records))
    print(len(valid_records))

    print("Setting up dataset reader")
    image_options = {'resize': False, 'resize_size': None}
